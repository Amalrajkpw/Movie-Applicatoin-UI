...
import 'package:movie_mod_application/view/screen_movie_info/screen_movie_info.dart';
...
class PopularMovieCard extends StatelessWidget {
  const PopularMovieCard({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: FutureBuilder(
        future: MoviesApi().fetchDataPopular(),
